                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < $num; $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo today($row['date'], 0, 20); ?>...
                                            </td>
                                            <td><img src="<?php echo $row['image_blog']; ?>" style="height:80px" alt="">
                                            </td>


                                            <td>
                                                <div class="table-actions d-flex align-items-center gap-3 fs-4">
                                                    <a href="edit-blogs?token=<?php echo $row['token']; ?>"
                                                        class="text-warning" data-bs-toggle="tooltip"
                                                        data-bs-placement="bottom" title="Edit"><i
                                                            class="bi bi-pencil-fill"></i></a>
                                                    <a href="delete?token=<?php echo ($row['token']); ?>&tab=<?= base64_encode('blog'); ?>&return=<?= base64_encode('blog2'); ?> "
